...
function Logo() {
  return (
    <a className="logo">
      <img src="/reactFetchApi/images/jujuLogo.svg" alt="Jujutsu Kaisen Logo" />
    </a>
  );
}
  ...
  return (
    <a className="btnDarkMode" onClick={onToggleTheme}>
      <img
        ...
        src={`${theme === "light" ? "/reactFetchApi/images/theme_dark.svg" : "/reactFetchApi/images/theme_light.svg"}`}
      />
    </a>
  );
}

...
function Logo() {
  return (
    <a className="logo">
      <img src="jamartindev/reactFetchApi/assets/jujuLogo.svg" alt="Jujutsu Kaisen Logo" />
    </a>
  );
}
  ...
  return (
    <a className="btnDarkMode" onClick={onToggleTheme}>
      <img
        ...
        src={`${theme === "light" ? "jamartindev/reactFetchApi/assets/theme_dark.svg" : "jamartindev/reactFetchApi/assets/theme_light.svg"}`}
      />
    </a>
  );
}
